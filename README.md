...
3. Shelterluv issues keys via a request form instead of a self-serve button. On the Integrations tab, look for a note like *"Need more API keys? Complete [this form](https://form.jotform.com/243268533362054) to request additional keys."* and open that link.
4. Fill out the form:
...
3. Give it a name (e.g. "Adoption Alets") and select your workspace.
...
2. Click the **"Raw"** button (or use the copy icon in the top-right of the file view), then select all the text and copy it.
3. Go to **[script.google.com](https://script.google.com)** and log in with your Google account.
4. Click **New project**.
5. You'll see a blank code editor with a file called `Code.gs`. Click inside it, select all the placeholder text, and delete it.
6. Paste in the code you copied in step 2.
